...
export const mapStateToProps = (state,props) => {
  return {
    cotisations : ((state.users || []).find(u => u._id == props.match.params.userId)||{}).cotisations || []
  }
}
const matchDispatchToProps = (dispatch) => bindActionCreators({requestCotisations,setCotisation},dispatch)

export function Cotisation(props) {
    useEffect(()=>{
...
export default connect(mapStateToProps,matchDispatchToProps)(Cotisation);
