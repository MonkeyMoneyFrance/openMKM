...
export default function editorElements({path,panel,subProps,itemEdition,droppedItem,index}){
  ...
  const addItem = () => panel == 'editColumn' ? droppedItem({type:'column',elements:[],style:{}},path,index) : panel == 'editLine' ? droppedItem({type:'line',columns:[{type:'column',elements:[],style:{}}],style:{}},path,index) : void 0
  return (
  <>
